...
extern const TAnimFrame g_allAnimFrames[10];

// All complete animations used in this example (NULL terminated, to know the end of the array)
extern TAnimFrame* const g_walkLeft[3];
extern TAnimFrame* const g_walkRight[3];
extern TAnimFrame* const g_jumpLeft[2];
extern TAnimFrame* const g_jumpRight[2];
extern TAnimFrame* const g_hitLeft[3];
extern TAnimFrame* const g_hitRight[3];
