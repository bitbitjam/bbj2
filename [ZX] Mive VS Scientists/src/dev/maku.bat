...
copy  ..\gfx\work.png ..\gfx\tileset.png

..\..\zxdev\bin\posterizezx.exe ..\gfx\tileset.png build\tileset.png
...
..\..\zxdev\bin\msc.exe ..\script\juego.spt msc.h 4
...
copy /b loader.tap + screen.tap + main.tap juego.tap
