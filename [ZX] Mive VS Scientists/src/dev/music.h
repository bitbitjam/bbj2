...
.pattern_ptr    DEFB  0
._s_note_ptr                                ; srand used the note ptr
.note_ptr       DEFW  $0000

._s_joy_read
.joy_read       DEFB  0                     ; add joy exit music read ptr
