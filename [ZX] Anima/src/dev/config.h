...
#define PLAYER_VY_INICIAL_SALTO 76	// Initial junp velocity (64/64 = 1 píxel/frame)
#define PLAYER_MAX_VY_SALTANDO	300	// Max jump velocity (320/64 = 5 píxels/frame)
#define PLAYER_INCR_SALTO		62		// acceleration while JUMP is pressed (48/64 = 0.75 píxeles/frame^2)
...
#define PLAYER_MAX_VX			112	// Max velocity (192/64 = 3 píxels/frame)
#define PLAYER_AX				34		// Acceleration (24/64 = 0,375 píxels/frame^2)
#define PLAYER_RX				56		// Friction (32/64 = 0,5 píxels/frame^2)
...
unsigned char comportamiento_tiles [] = {
	0, 8, 0, 8, 0, 8, 0, 0, 0, 1, 0, 0, 0, 9, 9, 9,
	0, 4, 0, 0, 0, 0, 0, 0, 4, 8, 0, 0, 0, 9, 9, 9,
	8, 0, 0, 0, 0, 0, 0, 0, 8, 0, 8, 0, 4, 1, 9, 0,
};
#endif
